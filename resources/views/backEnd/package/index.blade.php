                                    ...
                                    @foreach ($data as $key => $value)
                                        <tr>
                                                ...
                                                <div class="button-list custom-btn-list">
                                                    ...
                                                    @else
                                                        <form method="post" action="{{ route('packages.active') }}"
                                                            ...
                                                            <input type="hidden" value="{{ $value->id }}"
                                                                name="hidden_id">
                                                            <button type="button" class="change-confirm"
                                                                title="Inactive"><i class="fe-thumbs-up"></i></button>
                                                        </form>
                                                    @endif
                                            ...
                                            <td>
                                                ...
                                                <p class="m-0">Feature Package :
                                                    {{ $value->feature_product == 1 ? 'Yes' : 'No' }}</p>
                                                <p class="m-0">New Arrival :
                                                    {{ $value->new_arrival == 1 ? 'Yes' : 'No' }}</p>
                                            </td>
                                            <td>
                                                @if ($value->status == 1)
