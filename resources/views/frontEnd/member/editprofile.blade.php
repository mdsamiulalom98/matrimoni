                    ...
                    <form action="{{ route('member_register') }}" method="POST">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="{{ $member->name }}" placeholder="Full Name" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="religion_id">
                                    ...
                                    @foreach ($religions as $religion)
                                        <option {{ $memberInfo->religion_id == $religion->id ? 'selected' : '' }} value="{{ $religion->id }}">{{ $religion->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
