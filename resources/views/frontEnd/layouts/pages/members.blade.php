...
<section class="member-profile-section section-padding">
    <div class="container">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="nearby-match-tab" data-bs-toggle="tab" data-bs-target="#nearby-match" type="button" role="tab" aria-controls="nearby-match" aria-selected="false">Near by Match</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="view-not-contact-tab" data-bs-toggle="tab" data-bs-target="#view-not-contact" type="button" role="tab" aria-controls="view-not-contact" aria-selected="false">View Not Contact</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="view-profile-tab" data-bs-toggle="tab" data-bs-target="#view-profile" type="button" role="tab" aria-controls="view-profile" aria-selected="false">View My Profile</button>
            </li>
        </ul>
