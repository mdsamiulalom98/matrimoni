        ...
        <div class="row justify-content-center">
            <div class="col-sm-5">
                <div class="form-content shadow-lg p-4 rounded login_container">
                    <p class="auth-title text-center mb-4">🔑 Customer Login</p>
                    <form action="{{route('customer.signin')}}" method="POST" data-parsley-validate="">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" id="phone" class="form-control @error('phone') is-invalid @enderror"
                                placeholder="Enter Your Mobile Number" name="phone" value="{{ old('phone') }}" required>
                            @error('phone')
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{route('customer.forgot.password')}}" class="forget-link text-danger">
