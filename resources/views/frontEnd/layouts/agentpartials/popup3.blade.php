<fieldset id="familyInfo">
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                <label>Guradian Phone <span class="bn_lable">(অভিভাকরে নম্বর)</span> *</label>
                <input type="number" name="guardian_phone" placeholder="Guardian Phone">
            </div>
        </div>

        <div class="col-sm-12">
            <div class="form-group">
                <label>What is the family religious environment like? <span class="bn_lable">( পারিবারিক দ্বীনি পরিবেশ
                        কেমন )</span> *</label>
                <input type="text" name="religious_status" placeholder="Guardian's profession" required>
            </div>
        </div>

        <div class="col-sm-12">
            <div class="form-group">
                <label>Write about the family and the financial situation of the household<span class="bn_lable">( পরিবার ও পরিবারের অর্থনৈতিক অবস্থা সম্পর্কে লিখুন )</span>
                    *</label>
                <textarea id="about_family" name="about_family" rows="4" cols="50"></textarea>
            </div>
        </div>
    </div>
</fieldset>
