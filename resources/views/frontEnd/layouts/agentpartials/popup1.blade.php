<fieldset id="basicInfo">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="form-group">
                <label>Write about your hobbies, likes, dislikes, interests, dreams, etc<span class="bn_lable">(নিজের শখ,পছন্দ, অপছন্দ ,রুচিবোধ, স্বপ্ন ইত্যাদি বিষয়ে লিখুন)</span> *</label>
                <textarea id="about_hobby" name="about_hobby" rows="4" cols="50"></textarea>
            </div>
        </div>
    </div>
</fieldset>
